...
class Tower(Base):
    ...
    location_no: Mapped[str | None] = mapped_column(String(50))

    tower_type: Mapped[str | None] = mapped_column(String(100))
    ...
    towers_utilized: Mapped[str | None] = mapped_column(String(150))

    soil_strata: Mapped[str | None] = mapped_column(String(150))
    foundation_class: Mapped[str | None] = mapped_column(String(150))
    ...
    earthing_type: Mapped[str | None] = mapped_column(String(150))
    earth_wire_type: Mapped[str | None] = mapped_column(String(150))
    telecom_joint_box: Mapped[str | None] = mapped_column(String(150))
